...
**Prevention:** Always sanitize inputs passed to `.ilike()` using `str.replace(/[%_\\*?]/g, (match) => "\\" + match)` to prevent unauthorized pattern matching or slow query DoS attacks.
