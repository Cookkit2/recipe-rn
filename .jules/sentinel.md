...
**Learning:** Postgres `ILIKE` evaluates '%' and '_' as wildcards, and '\' as an escape character. PostgREST also treats '*' as a wildcard. Passing unsanitized input allows attackers to execute broad pattern matching or cause slow query DoS.
