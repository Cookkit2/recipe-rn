...
## 2026-09-13 - RecipeStep Accessibility Label Override
**Learning:** In React Native checkboxes, the accessibilityLabel should describe the item's identity rather than the action to be taken, otherwise it reads confusingly.
**Action:** Use accessibilityHint for instructions and accessibilityLabel for the item's identity.
