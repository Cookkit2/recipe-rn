...
// Helper components for React Native friendly formatting
const Strong = ({ children }: { children: React.ReactNode }) => (
  <Text className="font-urbanist-semibold text-foreground">{children}</Text>
);
...
const Link = ({
  ...
  <Pressable onPress={() => Linking.openURL(href)}>
    <Text className="text-blue-600 underline">{children}</Text>
  </Pressable>
);
...
export default function PrivacyScreen() {
  return (
    <View className="flex-1 bg-background">
      <ScrollView className="px-10 pb-10 font-urbanist-regular">
        ...
        <UnorderedList>
          ...
          <ListItem>
            <P>
              <Strong>Application</Strong> refers to Cookkit, the software
          ...
          <ListItem>
            <P>
              ...
              in this Agreement) refers to Cookkit.
            </P>
          </ListItem>
          <ListItem>
            <P>
        ...
        <UnorderedList>
          <ListItem>By email: cookkit01@gmail.com</ListItem>
        </UnorderedList>
      </ScrollView>
    </View>
  );
