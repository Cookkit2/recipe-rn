...
module.exports = {
  ...
  transformIgnorePatterns: [
    "node_modules/(?!(react-native|@react-native|@nozbe|@expo|expo|expo-modules-core|expo-constants|expo-secure-store|expo-crypto|expo-auth-session|expo-linking|expo-store-review|react-navigation|react-native-reanimated|react-native-worklets|@rn-primitives|llama\\.rn|expo-file-system|expo-maps|lucide-react-native|@testing-library)/)",
  ],
  moduleNameMapper: {
