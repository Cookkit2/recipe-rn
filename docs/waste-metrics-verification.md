...
- - co2FromWaste: 16.25 kg (6.5 _ 2.5)
    _/
...
- - Check analytics screen shows "25kg" CO2
    ...
    formula: "totalQuantityWasted _ CO2_CONVERSION_FACTOR",
    };
...
- - longestStreak: Days before first waste streak
    ...
    inputs: {
    wasteDates: [Date.now() - 5 _ 24 _ 60 _ 60 \* 1000],
    },
    expected: {
    currentStreak: 5,
...
- Use this to manually verify expected values
  ...
  const co2FromWaste = totalQuantityWasted _ CO2_CONVERSION_FACTOR;
