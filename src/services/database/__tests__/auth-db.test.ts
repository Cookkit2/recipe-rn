...
describe('Auth Database', () => {
  ...
  beforeEach(async () => {
    ...
    mockCrypto.digestStringAsync.mockResolvedValue('abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890');
  ...
  describe('Database Initialization', () => {
    ...
    it('should create sessions table', async () => {
      expect(mockDb.execAsync).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS sessions'));
    });

    it('should create refresh_tokens table', async () => {
      expect(mockDb.execAsync).toHaveBeenCalledWith(expect.stringContaining('CREATE TABLE IF NOT EXISTS refresh_tokens'));
    });
