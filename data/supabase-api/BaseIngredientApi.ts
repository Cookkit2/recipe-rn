...
/**
 * Escapes characters that are treated as wildcards by Supabase/PostgREST .ilike() / .like().
 * PostgREST supports '*', '%', and '_' as wildcards.
 */
